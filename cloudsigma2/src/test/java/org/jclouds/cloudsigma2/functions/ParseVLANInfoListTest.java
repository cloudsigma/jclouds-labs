 ...
 */
@Test(groups = "unit")
public class ParseVLANInfoListTest extends CloudSigma2ParserTest{

    private final static ParseVLANInfoList PARSE_VLAN_INFO_LIST = Guice.createInjector(new GsonModule()).getInstance(ParseVLANInfoList.class);

    private List<VLANInfo> expected;
    ...
    public void setUp() throws Exception {
        ...
        expected = ImmutableList.of(
                ...
                , new VLANInfo.Builder()
                        ...
                        .owner(owner)
                        .resourceUri(new URI("/api/2.0/vlans/00b445a9-3936-47e5-ba8a-38adcf43db20/"))
