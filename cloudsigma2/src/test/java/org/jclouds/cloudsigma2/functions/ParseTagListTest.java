 ...
 */
@Test(groups = "unit")
public class ParseTagListTest extends CloudSigma2ParserTest{

    private static final ParseTagList PARSE_TAG_LIST = Guice.createInjector(new GsonModule()).getInstance(ParseTagList.class);

    private List<Tag> expected;
    ...
    public void setUp() throws Exception {
        ...
        expected = ImmutableList.of(
            new Tag.Builder()
                ...
                .name("new tag")
                .owner(owner)
                .resourceUri(new URI("/api/2.0/tags/956e2ca0-dee3-4b3f-a1be-a6e86f90946f/"))
                .resources(new ArrayList<TagResource>())
